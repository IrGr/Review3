...
public partial class Tilbud : System.Web.UI.Page
{
    ...
    {
        if (Helper.ErLoggetInd() == true && Session[NavnKonstant.SessionBrugerNavn] != null)
        {
            SqlCommand cmd = new SqlCommand(@"SELECT * FROM tilbud join billeder on bill_id = fk_bill_id",conn);
            conn.Open();
        ...
        {
            Image_GestTilbud.ImageUrl = "~/images/reklam/tilbudgeast.jpg";
            Image_GestTilbud.CssClass = "img-responsive";
        }
